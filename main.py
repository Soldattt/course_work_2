...
from src.utils import get_top_aeroplanes, get_aeroplanes_by_altitude, filter_aeroplanes
...
def user_interaction():
    ...
    filter_words = input("Введите названия стран для фильтрации по стране регистрации (введите наименование стран через запятую): ").split(",")
    altitude_range = input("Введите диапазон высот полета (введите начальную и конечную высоту полета через тире '-'): ").split("-")  # Пример: 100000 - 150000
